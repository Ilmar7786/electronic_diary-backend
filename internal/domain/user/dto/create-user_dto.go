...
type CreateUserDTO struct {
	Surname     string         `json:"surname" minLength:"1" maxLength:"40" validate:"required"`
	Name        string         `json:"name" minLength:"1" maxLength:"40" validate:"required"`
	Patronymic  string         `json:"patronymic" minLength:"1" maxLength:"40" validate:"required"`
